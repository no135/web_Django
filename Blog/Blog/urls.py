...
from News.views import blog, blog_detail,category_blog,category_list,news_admin,article_edit,delete_news,category_edit,category_delete
...
urlpatterns = [
    ...
    path('category_edit/<int:category_id>/', category_edit, name="category_edit_url"),
    path('category_delete/<int:category_id>/', category_delete, name="category_delete_url"),
